...
<head>
    ...
    <title>LACAL SERTIFIKAT | Edit Data User</title>
    <!-- LINK TO CSS -->
...
<body>
    <div class="container-edit-data">
        ...
        <div class="wrapper-form-edit">
            <form action="{{url('pengguna/'.$data->id)}}" class="form-data" method="post">
                @csrf
                @method('PUT')
                <label for="id" class="label-form-input-data-one">ID :</label>
                <input readonly value="{{ $data->id }}" value="" class="input-form-user-one">
                <br>
                <label for="nama" class="label-form-input-data-two">Nama  :</label>
                <input type="text" id="nama" name="nama" value="{{ $data->nama}}" class="input-form-user-two">
                <br>
                <label for="nisn" class="label-form-input-data-three">NISN :</label>
                <input type="number" id="nisn" name="nisn" value="{{ $data->nisn}}" class="input-form-user-three">
                <br>
