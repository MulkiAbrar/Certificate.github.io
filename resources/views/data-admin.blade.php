    ...
    <label for="check">
        ...
        <section class="wrapping-data">
            <div class="container-content-header">
                <header class="header-beranda">Data Admin<a class="eng">/Admin's Data</a></header>
            </div>
            <div class="container-form-input-data">
                ...
                @endif
                <form action="{{url ('admin')}}" class="form-data" method="post">
                    @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="action-btn">
                                    <a href="{{url('admin/'.$item->id.'/edit')}}" class="edit">Edit</a>
                                    <form onsubmit="return confirm('apakah anda yakin untuk menghapus')" action="{{url ('admin/'.$item->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
