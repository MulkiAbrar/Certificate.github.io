    ...
    <label for="check">
        ...
        <div class="container-sidebar">
            <header class="font-sidebar">Hello! User!</header>
                ...
                <img src="assets/img/icons8-logout-32.png" alt="" width="30" height="30" class="icon-logout"><a href="
                <a href="{{url('/cek')}}" class="navbar-logout" onclick="return validateBack()">Kembali</a>

                <script>
                    function validateBack() {
                        var konfirmasi = confirm('Anda yakin ingin kembali?');
